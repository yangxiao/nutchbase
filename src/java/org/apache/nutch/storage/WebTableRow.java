...
public class WebTableRow extends NutchTableRow implements SpecificRecord {
  public static final Schema _SCHEMA = Schema.parse("{\"type\":\"record\",\"name\":\"WebTableRow\",\"namespace\":\"org.apache.nutch.storage\",\"fields\":[{\"name\":\"fetchTime\",\"type\":\"long\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"text\",\"type\":\"string\"},{\"name\":\"status\",\"type\":\"int\"},{\"name\":\"outlinks\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"metadata\",\"type\":{\"type\":\"map\",\"values\":\"bytes\"}}]}");
  ...
  public void set(int _field, Object _value) {
    ...
    case 4: setFieldChanged(4);outlinks = (Map<Utf8,Utf8>)_value; break;
    case 5: setFieldChanged(5);metadata = (Map<Utf8,ByteBuffer>)_value; break;
    default: throw new AvroRuntimeException("Bad index");
    }
  }
  ...
  public Map<Utf8,Utf8> getOutlinks() {
    return (Map<Utf8,Utf8>) get(4);
  }
  public void setOutlinks(Map<Utf8,Utf8> value) {
    set(4, value);
  }
  public Map<Utf8,ByteBuffer> getMetadata() {
    return (Map<Utf8,ByteBuffer>) get(5);
  }
  public void setMetadata(Map<Utf8,ByteBuffer> value) {
    set(5, value);
  }
}
